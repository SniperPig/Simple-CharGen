...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="http://localhost/Simple-CharGen/clientApi/SetOriginAndDestination.php">Search another route</a>
...
// if($response == NULL || $response->status == "INVALID_REQUEST"){
//     echo"<h1> INVALID ADDRESS FORMAT! </h1>";
//     echo'<form action="/test/SetOriginAndDestination.php" method="post">
//         <button class="w-100 btn btn-lg btn-primary" type="submit" name="SubmitGetDirection">Return Back</button>
//         </form>';
